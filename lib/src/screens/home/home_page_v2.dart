...
import 'package:hr_platform/src/screens/profile/profile_page.dart';
...
class _HomePageV2State extends State<HomePageV2> {
  ...
  Widget build(BuildContext context) {
    ...
    if (listOfDocumentsTypeID.contains(rightWidgetID) &&
        documentsView != null) {
      rightWidget = documentsView!;
    } else if (rightWidgetID == "Home") {
            ...
            children: [
              ...
              Wrap(
                children: [
                  ...
                  """,
                    id: "future_development_plan",
                  ),
                  generateCard(
                    index: 6,
                    titleName: "E-Learning",
                    description: "Training platform for employee development.",
                    iconSVG:
                        """<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="67" height="67" viewBox="0 0 67 67">
                  ...
                  generateCard(
                    ...
                    description: "Internal updates and communication bulletin.",
                    iconSVG:
                        """<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="67" height="67" viewBox="0 0 67 67">
    ...
    } else if (rightWidgetID == "Profile") {
      rightWidget = Expanded(child: ProfilePage());
    } else if (rightWidgetID == "Notifications") {
      rightWidget = Expanded(child: NotificationPage());
    } else if (rightWidgetID == "Setting") {
      rightWidget = Expanded(child: SettingsPage());
    }
    ...
    return Scaffold(
      ...
      drawer: isMobileView
          ...
          : null,
      body: Row(
        children: [if (!isMobileView) leftWidget, rightWidget],
      ),
    );
  }
...
List<String> listOfDocumentsTypeID = [
  "company_policy",
  "employee_handbook",
  "leaver_management",
